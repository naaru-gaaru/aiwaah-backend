...
# =====================================================
# SUPABASE TOKEN VERIFICATION (READ-ONLY)
# =====================================================
...
def verify_supabase_token(token: str):
    """
    Verifies that Supabase issued this token.
    Supabase already validated Google.
    """
...
# =====================================================
# CHAT ENDPOINT (PUBLIC – UNCHANGED)
# =====================================================
